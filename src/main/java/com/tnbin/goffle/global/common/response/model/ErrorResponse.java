...
public class ErrorResponse extends CommonResponse {
     ...
     * @return 응답 객체
     */
    public static ResponseEntity<ErrorResponse> fail(final ResponseEnum responseEnum,
                                                     final List<ValidationErrors> errors) {
     ...
     * @return 응답 객체
     */
    public static ResponseEntity<ErrorResponse> error(final ResponseEnum responseEnum) {
        return ResponseEntity
                .status(responseEnum.getStatus())
                .body(ErrorResponse.builder()
                        .code(responseEnum.getCode())
