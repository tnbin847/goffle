...
public class SignUpRequest {
    ...
    @Pattern(regexp = "^[A-Za-z0-9]{6,20}$", message = "아이디는 영문과 숫자 조합의 6~20자로 입력해주세요.")
    ...
    private final int enabledAt = StatusFormat.YES.getNumber();
    ...
    @Builder
    public SignUpRequest(String loginId, String name, String email, String password, LoginType loginType) {
